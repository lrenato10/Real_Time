...
//                rt_mutex_release(&mutex_robot);
//
//                //to verify if we lost connectivity
//                if (msg_reloadwd->GetID() == MESSAGE_ANSWER_ROBOT_TIMEOUT){
//                    counter = counter+1;
//                } else {
//                    counter = 0;
//                }               
//            }
//    }
//    // If counter=3 send connection lost
